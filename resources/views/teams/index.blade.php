...
@endif
    <div class="col-md-8 col-md-offset-2">
        <div class="row">
            ...
            <div class="col-md-2"><a style="float: right;" class="h3" href="@if($admin) {{ url('/home') }} @else {{ url('/') }} @endif">Home</a></div>
        </div>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <ul>
                    ...
                    @if($admin)<a href="#" class="add-modal"><li>Add a Team</li></a>@endif
                </ul>
            </div>
