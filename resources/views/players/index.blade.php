        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <ul>
                    ...
                    @if($admin)<a href="#" class="add-modal"><li>Add a Player</li></a>@endif
                </ul>
            </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if ((data.errors)) {
                        ...
                        $('#postTable').prepend("<tr class='item" + data.id + "'><td class='col1'>" + data.id + "</td><td>" + data.name + "</td><td>" +  data.team_name + "</td><td>Just now!</td><td><button class='show-modal btn btn-success' data-id='" + data.id + "' data-name='" + data.name + "' data-team_id='" + data.team_id + "' data-team_name='" + data.team_name + "'><span class='glyphicon glyphicon-eye-open'></span> Show</button> <button class='edit-modal btn btn-info' data-id='" + data.id + "' data-name='" + data.name + "' data-team_id='" + data.team_id + "' data-team_name='" + data.team_name + "'><span class='glyphicon glyphicon-edit'></span> Edit</button> " +
                        "<button class='delete-modal btn btn-danger' data-id='" + data.id + "' data-name='" + data.name + "' data-team_id='" + data.team_id + "' data-team_name='" + data.team_name + "'><span class='glyphicon glyphicon-trash'></span> Delete</button></td></tr>");
